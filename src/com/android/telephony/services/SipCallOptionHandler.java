...
import com.android.telephony.services.sip.SipProfileDb;
import com.android.telephony.services.sip.SipSettings;
import com.android.telephony.services.sip.SipSharedPreferences;
        ...
        runOnUiThread(new Runnable() {
            public void run() {
                ...
                if (mUseSipPhone && mOutgoingSipProfile == null) {
                    ...
                    PhoneGlobals.getInstance().callManager.placeCall(mIntent);
                }
                finish();
            }
        });
