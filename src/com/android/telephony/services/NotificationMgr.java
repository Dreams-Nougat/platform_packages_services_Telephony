...
public class NotificationMgr implements CallerInfoAsyncQuery.OnQueryCompleteListener{
    ...
    /* package */ void updateCfi(boolean visible) {
        ...
        if (visible) {
            ...
            if (showExpandedNotification) {
                ...
                intent.setClassName("com.android.telephony.services",
                        "com.android.telephony.servies.CallFeaturesSetting");
    ...
    /* package */ void showDataDisconnectedRoaming() {
        ...
        Intent intent = new Intent(mContext,
                com.android.telephony.services.MobileNetworkSettings.class);
    ...
    private void showNetworkSelection(String operator) {
        ...
        intent.setComponent(new ComponentName("com.android.telephony.services",
                "com.android.telephony.services.NetworkSetting"));
