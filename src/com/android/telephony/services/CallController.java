...
import com.android.telephony.services.Constants.CallStatusCode;
import com.android.telephony.services.InCallUiState.InCallScreenMode;
import com.android.telephony.services.OtaUtils.CdmaOtaScreenState;
 ...
 *       operation should go through CallManagerService (that then will handle it in this
 *       class).
 */
        ...
        switch (msg.what) {
            ...
            case THREEWAY_CALLERINFO_DISPLAY_DONE:
                ...
                if (mApp.cdmaPhoneCallState.getCurrentCallState()
                    ...
                    // should make a call to CallManagerService here that will send out a update to
                    // the clients.
                }
                break;
...
//                mApp.setBeginningCall(true);
        ...
        // TODO: Should be handled in CallManagerService instead but we keep it commented here to not
        // forget it.
    }
