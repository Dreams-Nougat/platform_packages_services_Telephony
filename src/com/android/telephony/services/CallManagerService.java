...
package com.android.telephony.services;
...
import com.android.telephony.client.ICallManagerService;
...
/**
 * We call this class CallManagerService since we think it should only handle call handling events
 ...
 */
public class CallManagerService extends Service implements
        CallerInfoAsyncQuery.OnQueryCompleteListener, CallTime.OnTickListener {

    private final static String LOG_TAG = "CallManagerService";
     ...
     * service.
     */
    final RemoteCallbackList<ICallManagerServiceCallBack> mCallbacks
            = new RemoteCallbackList<ICallManagerServiceCallBack>();
        ...
        public void handleMessage(Message msg) {
            switch(msg.what) {
                ...
                case MSG_REQUEST_FORGROUND_CALLER_INFO:
                    if (msg.obj instanceof ICallManagerServiceCallBack) {
                        ICallManagerServiceCallBack cb = (ICallManagerServiceCallBack)msg.obj;
     ...
     *
     */
    private final ICallManagerService.Stub mBinder = new ICallManagerService.Stub() {

        /**
         *
         */
        public void registerCallback(ICallManagerServiceCallBack cb) {
         ...
         *
         */
        public void unregisterCallback(ICallManagerServiceCallBack cb) {
         ...
         *
         */
        public void requestForegroundCallerInfo(ICallManagerServiceCallBack cb) {
         ...
         *
         */
        public void requestBackgroundCallerInfo(ICallManagerServiceCallBack cb) {
         ...
         *
         */
        public void requestConferenceCallersInfo(ICallManagerServiceCallBack cb) {
     ...
     *
     */
    private void internalRequestForegroundCallerInfo(ICallManagerServiceCallBack cb) {
        Call ringingCall = mCallManager.getFirstActiveRingingCall();
        Call foregroundCall = mCallManager.getActiveFgCall();
     ...
     *
     */
    private void internalRequestBackgroundCallerInfo(ICallManagerServiceCallBack cb) {
        Call backgroundCall = mCallManager.getFirstActiveBgCall();
    ...
    private class CallerInfoQueryListener
        ...
        public void onCallerInfoQueryComplete(String name, String number, String typeofnumber,
                Drawable photo, int presentation, ICallManagerServiceCallBack cb) {
    ...
    *
    */
   private void notifyCallStateToRegister(ICallManagerServiceCallBack cb) {
       Call ringingCall = mCallManager.getFirstActiveRingingCall();
       Call foregroundCall = mCallManager.getActiveFgCall();
       Call backgroundCall = mCallManager.getFirstActiveBgCall();
     ...
     *
     */
    private void notifyIncommingCall(boolean isWaiting, ICallManagerServiceCallBack cb) {
     ...
     *
     */
    private void notifyOutgoingCall(boolean isAlerting, ICallManagerServiceCallBack cb) {
    ...
    private void notifyActiveCall(Call call, boolean hasBackgroundCall,
            ICallManagerServiceCallBack cb) {
    ...
    private void notifyHoldCall(Call call, ICallManagerServiceCallBack cb) {
        log("notifyHoldCall");
     ...
     */
    private void notifyDisconnecting(ICallManagerServiceCallBack cb) {
     ...
     */
    private void notifyAllCallsDisconnected(ICallManagerServiceCallBack cb, int cause) {
    ...
    private void notifyCallerInfoUpdate(boolean isForegroundCall, String name, String number,
            String typeofnumber, Bitmap photo, int presentation, ICallManagerServiceCallBack cb) {
