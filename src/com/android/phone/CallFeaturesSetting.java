...
public class CallFeaturesSetting extends PreferenceActivity
    ...
    public boolean onPreferenceChange(Preference preference, Object objValue) {
        ...
        if (preference == mVibrateWhenRinging) {
            ...
            Settings.System.putInt(mPhone.getApplicationContext().getContentResolver(),
    ...
    private void doSubPick(Preference preference) {
        ...
        if (PhoneUtils.isValidSubId(subId)) {
            ...
            initVoiceMailProvidersItems(SubPickHandler.INVALID_SUB_ID);
        }
    }
    ...
    public void onSubPickComplete(int completeKey, long subId, Intent intent) {
        ...
        if (SubPickHandler.SUB_PICK_COMPLETE_KEY_SUB == completeKey
                && mVoicemailCategory == mClickedPreference) {
            initVoiceMailProvidersItems(subId);
