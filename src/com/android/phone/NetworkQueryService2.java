 ...
 * availability.   
 */
public class NetworkQueryService2 extends Service {
    // debug data
    private static final String LOG_TAG = "NetworkQuery2";
    ...
    public class LocalBinder extends Binder {
        INetworkQueryService2 getService() {
            return mBinder;
        }
    }
     ...
     */
    final RemoteCallbackList<INetworkQueryServiceCallback2> mCallbacks =
        new RemoteCallbackList<INetworkQueryServiceCallback2> ();
    
    /**
     * Implementation of the INetworkQueryService2 interface.
     */
    private final INetworkQueryService2.Stub mBinder = new INetworkQueryService2.Stub() {
         ...
         * completion.
         */
        public void startNetworkQuery(INetworkQueryServiceCallback2 cb) {
            if (cb != null) {
        ...
        /**
         * Stops a query with a INetworkQueryServiceCallback2 object as
         * a token.
         */
        public void stopNetworkQuery(INetworkQueryServiceCallback2 cb) {
    ...
    public void onCreate() {
        mState = QUERY_READY;
        mPhone = PhoneFactory.getDefaultPhone(SimCardID.ID_ONE);
    }
    ...
    private void broadcastQueryResults (AsyncResult ar) {
        ...
        synchronized (mCallbacks) {
            ...
            for (int i = (mCallbacks.beginBroadcast() - 1); i >= 0; i--) {
                INetworkQueryServiceCallback2 cb = mCallbacks.getBroadcastItem(i); 
