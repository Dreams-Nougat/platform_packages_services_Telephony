...
public class CallNotifier extends Handler
    ...
    private final class MultiPhoneStateListener extends PhoneStateListener {

        MultiPhoneStateListener(int subscription) {
            super(subscription);
        }

        @Override
        public void onMessageWaitingIndicatorChanged(boolean mwi) {
            onMwiChanged(mwi, mSubscription);
        }
