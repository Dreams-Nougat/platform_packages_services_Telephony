 ...
 */
class SimContactAccountAuthenticator extends AbstractAccountAuthenticator {

    /** The tag used to log to adb console. **/
    private static final String TAG = "SimContactAccountAuthenticator";

    public SimContactAccountAuthenticator(Context context) {
        super(context);
        Log.d(TAG, "=>SimContactAccountAuthenticator()");
    }
    ...
    public Bundle getAccountRemovalAllowed (AccountAuthenticatorResponse response, Account account) {
        Log.v(TAG, "=>getAccountRemovalAllowed()");
        final Bundle result = new Bundle();
