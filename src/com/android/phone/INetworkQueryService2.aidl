...
import com.android.phone.INetworkQueryServiceCallback2;
 ...
 * GSMPhone layer.
 */
oneway interface INetworkQueryService2 {
     ...
     */
    void startNetworkQuery(in INetworkQueryServiceCallback2 cb);
     ...
     */
    void stopNetworkQuery(in INetworkQueryServiceCallback2 cb);
}
