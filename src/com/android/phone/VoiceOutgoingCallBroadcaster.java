...
/**
 * VoiceOutgoingCallBroadcaster receives CALL and CALL_PRIVILEGED Intents, and
 ...
 * broadcast.
 */
public class VoiceOutgoingCallBroadcaster extends Activity
        implements DialogInterface.OnClickListener, DialogInterface.OnCancelListener {

    private static final String PERMISSION = android.Manifest.permission.PROCESS_OUTGOING_CALLS;
    private static final String TAG = "VoiceOutgoingCallBroadcaster";
    ...
    public class OutgoingCallReceiver extends BroadcastReceiver {
        ...
        public void doReceive(Context context, Intent intent) {
            ...
            alreadyCalled = intent.getBooleanExtra(
                    VoiceOutgoingCallBroadcaster.EXTRA_ALREADY_CALLED, false);
            if (alreadyCalled) {
            ...
            if (TelephonyCapabilities.supportsOtasp(app.phone[simCardId.toInt()])) {
                ...
                if (activateState || dialogState) {
                    ...
                    app.clearOtaState();
/*jw TODO no more this function, wait till InCallUI is handled
...
*/
            ...
            originalUri = intent.getStringExtra(
                    VoiceOutgoingCallBroadcaster.EXTRA_ORIGINAL_URI);
            if (originalUri == null) {
    ...
    protected void onCreate(Bundle icicle) {
        ...
        if (getClass().getName().equals(intent.getComponent().getClassName())) {
            // If we were launched directly from the VoiceOutgoingCallBroadcaster,
...
/*jw TODO The session below is not in OutgoingCallBroadcaster.java anymore,
  probably not needed here as well. setLatestActiveCallOrigin() is gone as well
