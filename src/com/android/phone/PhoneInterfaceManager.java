...
public class PhoneInterfaceManager extends ITelephony.Stub {
    ...
    private Phone getPhone(long subscription) {
        return mApp.getPhone((int)subscription);
    }
    //
    // Implementation of the ITelephony interface.
    //
    ...
    public void dial(String number) {
        dialUsingSub(getPreferredVoiceSubscription(), number);
    }

    public void dialUsingSub(long subscription, String number) {
        ...
        PhoneConstants.State state = mCM.getState((int)subscription);
    ...
    public void callUsingSub(long subscription, String callingPackage, String number) {
     ...
     * @return true is a call was ended
     */
    public boolean endCallUsingSub(long subscription) {
        enforceCallPermission();
        return (Boolean) sendRequest(CMD_END_CALL, subscription, null);
    }

    public void answerRingingCall() {
        answerRingingCallUsingSub(getDefaultSubscription());
    }

    public void answerRingingCallUsingSub(long subscription) {
    ...
    public boolean isOffhookUsingSub(long subscription) {
    ...
    public boolean isRingingUsingSub(long subscription) {
    ...
    public boolean isIdleUsingSub(long subscription) {
    ...
    public boolean supplyPinUsingSub(long subscription, String pin) {
    ...
    public boolean supplyPukUsingSub(long subscription, String puk, String pin) {
    ...
    public int[] supplyPinReportResultUsingSub(long subscription, String pin) {
        enforceModifyPermission();
    ...
    public int[] supplyPukReportResultUsingSub(long subscription, String puk, String pin) {
        enforceModifyPermission();
    ...
    public void updateServiceLocationUsingSub(long subscription) {
    ...
    public boolean isRadioOnUsingSub(long subscription) {
    ...
    public void toggleRadioOnOffUsingSub(long subscription) {
        enforceModifyPermission();
    ...
    public boolean setRadioUsingSub(long subscription, boolean turnOn) {
        enforceModifyPermission();
    ...
    public boolean setRadioPower(boolean turnOn) {
        return setRadioPowerUsingSub(getDefaultSubscription(), turnOn);
    }

    public boolean setRadioPowerUsingSub(long subscription, boolean turnOn) {
        enforceModifyPermission();
        getPhone(subscription).setRadioPower(turnOn);
        return true;
    }
    ...
    public boolean handlePinMmiUsingSub(long subscription, String dialString) {
        enforceModifyPermission();
        return (Boolean) sendRequest(CMD_HANDLE_PIN_MMI, dialString, subscription);
    }

    public void cancelMissedCallsNotification() {
        cancelMissedCallsNotificationUsingSub(getDefaultSubscription());
    }

    public void cancelMissedCallsNotificationUsingSub(long subscription) {
        enforceModifyPermission();
    ...
    public int getCallStateUsingSub(long subscription) {
    ...
    public void enableLocationUpdatesUsingSub(long subscription) {
        mApp.enforceCallingOrSelfPermission(
    ...
    public void disableLocationUpdatesUsingSub(long subscription) {
        mApp.enforceCallingOrSelfPermission(
                android.Manifest.permission.CONTROL_LOCATION_UPDATES, null);
    ...
    public int getActivePhoneTypeUsingSub(long subscription) {
    ...
    public int getCdmaEriIconIndexUsingSub(long subscription) {
    ...
    public int getCdmaEriIconModeUsingSub(long subscription) {
    ...
    public String getCdmaEriTextUsingSub(long subscription) {
     ...
     */
    public int getVoiceMessageCountUsingSub( long subscription) {
     ...
     */
    @Override
    public int getNetworkTypeUsingSub(long subscription) {
     ...
     */
    @Override
    public int getDataNetworkTypeUsingSub(long subscription) {
        return getPhone(subscription).getServiceState().getDataNetworkType();
    }
     ...
     */
    @Override
    public int getVoiceNetworkTypeUsingSub(long subscription) {
     ...
     */
    public boolean hasIccCardUsingSub(long subscription) {
    ...
    public int getLteOnCdmaModeUsingSub(long subscription) {
