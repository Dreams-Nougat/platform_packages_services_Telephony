...
public class PhoneInterfaceManager extends ITelephony.Stub {
    ...
    public void dialUsingSub(int subscription, String number) {
    ...
    public void answerRingingCallUsingSub(int subscription) {
    ...
    public boolean setRadioPowerUsingSub(int subscription, boolean turnOn) {
        enforceModifyPermission();
    ...
    public void cancelMissedCallsNotificationUsingSub(int subscription) {
        enforceModifyPermission();
