...
/**
 * VTOutgoingCallBroadcaster receives CALL and CALL_PRIVILEGED Intents, and
 ...
 * broadcast.
 */
public class VTOutgoingCallBroadcaster extends Activity
        implements DialogInterface.OnClickListener, DialogInterface.OnCancelListener {

    private static final String PERMISSION = android.Manifest.permission.PROCESS_OUTGOING_CALLS;
    private static final String TAG = "VTOutgoingCallBroadcaster";
    ...
    public static final String ACTION_VT_VOICE_CALL = "com.android.phone.action.ACTION_VT_VOICE_CALL";
    ...
    /**
     * Identifier for video telephone
     */    
    public static final String EXTRA_VTPHONE = "com.android.phone.extra.VTPHONE";
    public static final String EXTRA_VTPHONE_NUMBER = "com.android.phone.extra.VTPHONE_NUMBER";
    ...
    public class OutgoingCallReceiver extends BroadcastReceiver {
        ...
        public void doReceive(Context context, Intent intent) {
            ...
            alreadyCalled = intent.getBooleanExtra(
                    VTOutgoingCallBroadcaster.EXTRA_ALREADY_CALLED, false);
            if (alreadyCalled) {
...
*/
            ...
            if (number == null) {
                ...
                return;
            } else if (PhoneNumberUtils.isLocalEmergencyNumber(number, context, simCardId)) {
                Log.w(TAG, "Cannot modify outgoing call to emergency number " + number + ".");
                return;
            }

            originalUri = intent.getStringExtra(
                    VTOutgoingCallBroadcaster.EXTRA_ORIGINAL_URI);
            if (originalUri == null) {
    ...
    private void startSipCallOptionHandler(Context context, Intent intent,
        ...
        /* VideoPhone */
        newIntent.putExtra(VTOutgoingCallBroadcaster.EXTRA_VTPHONE, true);
        newIntent.putExtra("simId", simCardId);
    ...
    protected void onCreate(Bundle icicle) {
        ...
        if (true) {
            Log.e(TAG, "onCreate: VT Framework not support !!!");
            return;
        }
        ...
        if (getClass().getName().equals(intent.getComponent().getClassName())) {
            // If we were launched directly from the VTOutgoingCallBroadcaster,
        ...
        if (action.equals(ACTION_VT_VOICE_CALL)) {
        ...
        if (Intent.ACTION_CALL.equals(action)) {
            ...
            Log.e(TAG, "onCreate: VT need to check this case !!!");
            callNow = true;
        } else {
...
/*jw TODO This section of code is removed from OutgoingCallBroadcaster.java, we probably
  don't need it here as well. setLatestActiveCallOrigin() api is obsolete also.
