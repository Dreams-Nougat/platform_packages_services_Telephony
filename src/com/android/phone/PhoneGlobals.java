...
public class PhoneGlobals extends ContextWrapper implements WiredHeadsetListener {
    ...
    public void onCreate() {
        ...
        if (mCM == null) {
            ...
            phoneMgr = PhoneInterfaceManager.init(this, PhoneFactory.getPhoneProxyManager(),
    ...
    private void onMMIComplete(AsyncResult r) {
        ...
        Phone phone = PhoneProxyManager.getPhoneProxyUsingSub(mmiCode.getSubId());
    ...
    private void initForNewRadioTechnology(long subId) {
        ...
        final Phone phone = PhoneProxyManager.getPhoneProxyUsingSub(subId);
    ...
    private class PhoneAppBroadcastReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals(Intent.ACTION_AIRPLANE_MODE_CHANGED)) {
                ...
                Phone phone = PhoneProxyManager.getPhoneProxy(intent.getIntExtra(PhoneConstants.SIM_ID_KEY,
                ...
                long subId = intent.getLongExtra(PhoneConstants.SUB_ID_KEY,
    ...
    private void handleServiceStateChanged(Intent intent) {
        ...
        if (ss != null) {
            Phone phone = PhoneProxyManager.getDefault().getPhoneProxy(ss.getSimId());
            if (phone != null) {
